...
public class DBUtil {
	...
	private static final String mySqlPwd="Password01";
	private static final String oraCS="jdbc:oracle:thin:@192.168.192.128:1521:xe";
	private static final String mySQLCS="jdbc:mysql://192.168.192.128:3306/world";
